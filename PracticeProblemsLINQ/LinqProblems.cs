...
namespace PracticeProblemsLINQ
{
    public static class LinqProblems
    {
        ...
        {
            //code
            var mike = customers.Where(n => n.FirstName == "Mike").Distinct().First();
            //return
            return mike;
        }
        #endregion
        ...
        {
            //code
            var newCustomer = customers.Where(n => n.Id == 3).First();

            newCustomer.FirstName = "Aaron";
            newCustomer.LastName = "Rodgers";
            //return
            return newCustomer;
        }
        #endregion
